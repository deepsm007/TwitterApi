...
public class Methods {
	 ...
	 * @throws Exception
	 */
	public static UserTwitterCredentials generateCredentials(String consumerKey, String consumerSecret)
		...
		try {
			...
			/*
			 * cb.setHttpProxyHost("proxy"); cb.setHttpProxyPort(8080);
			 */
	...
	/**
	 * Set initial configuration for twitter instance which are required to do
	 * API call. Here we set below four properties.
	 * 
	 * @param userTwitterDetails
	 * @return Twitter
	 */
	public static Twitter getByConfigureBuilder(UserTwitterCredentials userTwitterDetails) {
		Twitter twitter = null;
		try {
			ConfigurationBuilder cb = new ConfigurationBuilder();
			cb.setDebugEnabled(true).setOAuthConsumerKey(userTwitterDetails.getConsumerKey())
	...
	/**
	 * Getting the configuration for authentication by reading the
